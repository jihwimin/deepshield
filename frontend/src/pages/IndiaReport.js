     ...
     <nav className="nav-bar">
      ...
      <div className="report-content">
        ...
        <div className="report-box">
          ...
          <ul>
            <li>Cyber Peace Foundation is a non-profit organization that provides cybercrime prevention and victim support, and can receive counseling and support for deepfake damage.</li>
          </ul>
